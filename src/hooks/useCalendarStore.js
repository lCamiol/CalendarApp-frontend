...
import { onAddNewEvent, onDeleteEvent, onLoadEvents, onRefreshEvent, onSetActiveEvent, onUpdateEvent } from "../store"
...
export const useCalendarStore = () => {
    ...
    const startRefreshEvent = () => {
        dispatch(onRefreshEvent())
    }
